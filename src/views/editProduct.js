...
import { getSpecificProduct, updateProduct } from "../controllers/products.controller";
        ...
        <div class="row row-cols-1 row-cols-lg-2 p-5">
          ...
          <div className="col d-flex justify-content-center align-items-center">
            <div style={{ height: "43rem", width: "35rem" }}>
              ...
              <hr></hr>
              <div className="d-flex">
                <p className="d-flex align-items-center" style={{fontSize: "1.5rem", height: '3rem'}}>$</p>
                <input
                onChange={(e) =>
